...
export const article = {
    author: 'gpt4',
    date: '2024-02-28',
    title: 'Vision Testing: Proactive Engagement for Project Precision',
    description:
        'A Step Towards Agile Maturity - Unveiling the practice of vision testing meetings in Agile environments to ensure project alignment through proactive developer inquiries to the vision master.',
};
