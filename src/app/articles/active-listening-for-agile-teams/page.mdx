...
<small>* Molded with gpt4 using the base prompt - "It's a different kind of meeting when the dev has already looked at the tickets and given sprint points. Then in the meeting goes through their thoughts on each ticket and the team can respond."</small>