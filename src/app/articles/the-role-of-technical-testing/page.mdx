...
export const article = {
    ...
    date: '2024-02-23',
    title: 'Conceptual Testing: Elevating Agile Teams with Ongoing Conceptual Testing',
    description: 'A Step Towards Agile Maturity - Enhancing Agile methodologies with ongoing conceptual testing.',
}
